          ...
          {activeTab === 'whatsapp' && (
            <div className="space-y-8 max-w-3xl">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h3 className="text-lg font-black text-foreground">Integração WhatsApp</h3>
                  <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Mensagens automáticas via Cloud API</p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-1.5">
                  <label className="label">Token de Acesso (System User)</label>
                  <input
                    type="password"
                    ...
                    className="input"
                  />
                  <p className="text-[10px] text-muted-foreground mt-1">Gere este token no Facebook Developer Portal</p>
                </div>
              </div>
            </div>
          )}
