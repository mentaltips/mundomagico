...
import { Users, Clock, ArrowRight, ArrowLeft } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-black text-foreground">Minhas Turmas</h1>
          <p className="text-muted-foreground font-medium text-sm">Selecione uma turma para registrar a rotina do dia.</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="card flex flex-col items-center justify-center p-12 text-center border-dashed">
          ...
          <p className="text-xs text-muted-foreground font-medium mt-1">
            Você não está vinculada a nenhuma turma no momento. Fale com a coordenação.
          </p>
        </div>
      ) : (
        <div className="grid gap-4 sm:grid-cols-2">
