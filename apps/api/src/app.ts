...
app.use('/api/teacher', requireApiAuth, requireTenant, requireRole('ADMIN', 'ADMIN_ESCOLA', 'DIRETOR', 'PROFESSOR', 'COORDENADOR', 'MONITOR', 'CUIDADOR'), teacherRoutes)
app.use('/api/professor', requireApiAuth, requireTenant, requireRole('ADMIN', 'ADMIN_ESCOLA', 'DIRETOR', 'PROFESSOR', 'COORDENADOR', 'MONITOR', 'CUIDADOR'), teacherRoutes)
