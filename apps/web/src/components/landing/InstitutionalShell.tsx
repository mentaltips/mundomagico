      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-8">
            ...
            <span className="text-[10px] text-zinc-600 font-black uppercase tracking-widest">Termos</span>
              ...
              <a
                  key={i}
                  href={i === 0 ? 'https://instagram.com/mundomagicocajamar' : 'https://wa.me/551199999999'}
                  target="_blank"
          ...
          {/* Links */}
          <div>
            <h4 className="text-sm font-bold uppercase tracking-widest text-zinc-500 mb-6">Escola</h4>
            <ul className="space-y-3">
              {['Sobre Nós', 'Nossa Estrutura', 'Metodologia', 'Equipe'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-zinc-400 hover:text-white transition-colors font-medium">{item}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            <h4 className="text-sm font-bold uppercase tracking-widest text-zinc-500 mb-6">Famílias</h4>
            <ul className="space-y-3">
              {['Portal do Responsável', 'Cardápio', 'Calendário', 'Comunicados'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-zinc-400 hover:text-white transition-colors font-medium">{item}</a>
                </li>
              ))}
          ...
          <div>
            <h4 className="text-sm font-bold uppercase tracking-widest text-zinc-500 mb-6">Contato</h4>
            <ul className="space-y-3 text-zinc-400 font-medium">
              <li>📍 Cajamar, SP</li>
              <li>📞 (11) 9999-9999</li>
              <li>✉️ contato@mundomagicocajamar.com.br</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-zinc-500 text-sm">
            © {new Date().getFullYear()} Mundo Mágico Cajamar. Todos os direitos reservados.
          </p>
          <p className="text-zinc-600 text-xs">
            Desenvolvido com ♥ para a educação infantil
          </p>
        </div>
      </div>
    </footer>
